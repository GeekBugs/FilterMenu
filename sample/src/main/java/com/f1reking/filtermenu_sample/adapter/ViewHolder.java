...
public class ViewHolder {
    ...
    public ViewHolder setText(int viewId, String text, boolean visible) {
        TextView tv = getView(viewId);
        tv.setText(text);
     ...
     * glide
     */
    //public ViewHolder setNetImage(int viewId, String urlImage) {
    //    ImageView view = getView(viewId);
    //    Glide.with(mContext).load(urlImage).into(view);
    //    return this;
    //}
